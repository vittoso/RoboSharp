...
namespace RoboSharp.BackupApp.Win32Job
{
    public sealed class JobObject : IDisposable
    {
        ...
        public unsafe void SetLimits(JobObjectLimits limits)
        {
            ...
            var info = new JOBOBJECT_EXTENDED_LIMIT_INFORMATION
            {
                ...
                {
                    ActiveProcessLimit = new UIntPtr(limits.ActiveProcessLimit),
            ...
            if (!Windows.Win32.PInvoke.SetInformationJobObject(_jobHandle, JOBOBJECTINFOCLASS.JobObjectExtendedLimitInformation, &info, (uint)Marshal.SizeOf(typeof(JOBOBJECT_EXTENDED_LIMIT_INFORMATION))))
            {
